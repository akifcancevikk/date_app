...
import 'package:date_app/pages/detail_page.dart';
...
class _MainPageState extends ConsumerState<MainPage> {
  ...
  final NestedScrollController _scrollController = NestedScrollController();
  ...
  void initState() {
    ...
    Future.microtask(() => fetchMemories(ref, isRefresh: true));
  ...
  Future<void> _loadMore() async {
    ...
    await fetchMemories(ref); // isRefresh:false
  }
  ...
  Widget build(BuildContext context) {
    ...
    final memories = memoriesState.items;
                        ...
                        builder: (context) {
                          return AppFluidDialog(
                            ...
                            actions: [
                              ...
                              TextButton(
                                onPressed: () async {
                                  await createMemory(context, ref);
                                  _memoryNameController.clear();
                                  Navigator.pop(context);
                                },
                                child: Text(
              ...
              body: globalAppBar(
                ...
                CustomRefreshIndicator(
                  ...
                  onRefresh: () async {
                    ...
                    await fetchMemories(ref, isRefresh: true);
                    if (!mounted) return;
  ...
  Widget _buildMemoriesView(List memories) {
    ...
    if (memories.isEmpty && !isMoreLoading) {
      return ListView(
        physics: physics,
        controller: _scrollController,
        children: [
          SizedBox(
            height: ScreenHelper.screenHeight(context) * 0.75,
          ),
        ],
      );
    }
  ...
  Widget _buildMemoryItem(dynamic memory, {required bool isTwoColumn}) {
    ...
    final bottomSpace = isTwoColumn ? 20.0 : 50.0;
    final bottomPoloCardSpace = isTwoColumn ? 30.0 : 50.0;
                  ...
                  builder: (context) {
                    return AppFluidDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                          onPressed: () async {
                            await deleteMemory(context, ref, memory.id);
            ...
            builder: (context) {
              return AppFluidDialog(
                ...
                actions: [
                  ...
                  TextButton(
                    onPressed: () async {
                      await updateMemory(context, ref);
                      Navigator.pop(context);
                    },
